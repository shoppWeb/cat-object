...
<head>
    ...
    <link rel="stylesheet" href="/resource/ROOT/css/matrix-style.css" />
    <link rel="stylesheet" href="/resource/ROOT/css/matrix-media.css" />
...
<div id="sidebar" style="OVERFLOW-Y: auto; OVERFLOW-X:hidden;">
    <ul>
        ...
        <li class="submenu">
            ...
            <ul>
                <li><a class="menu_a" link="form-common.html"><i class="icon icon-caret-right"></i>数据库维护</a></li>
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="/root/admin/rootIndexControl/indexView" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
    </div>
    <!--End-breadcrumbs-->
    <iframe src="/WEB-INF/view/ROOT/index2.html" id="iframe-main" frameborder='0' style="width:100%;"></iframe>
</div>
<!--end-main-container-part-->

<script src="/resource/ROOT/js/excanvas.min.js"></script>
<script src="/resource/ROOT/js/jquery.min.js"></script>
<script src="/resource/ROOT/js/jquery.ui.custom.js"></script>
<script src="/resource/ROOT/js/bootstrap.min.js"></script>
<script src="/resource/ROOT/js/nicescroll/jquery.nicescroll.min.js"></script>
<script src="/resource/ROOT/js/matrix.js"></script>
