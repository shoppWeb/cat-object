...
$.extend(true,myflow.config.tools.states,{
	start : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : '/resource/extnd/myFlow/img/48/start_event_empty.png',width : 48, height:48},
				...
				props : {
					...
					temp3: {name:'temp3', label : '自定义', value:'', editor: function(){return new myflow.editors.customFunction([{name:'aaa',value:1},{name:'bbb',value:2}]);}}
				}},
			end : {showType: 'image',type : 'end',
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : '/resource/extnd/myFlow/img/48/end_event_terminate.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-cancel' : {showType: 'image',type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : '/resource/extnd/myFlow/img/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-error' : {showType: 'image',type : 'end-error',
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : '/resource/extnd/myFlow/img/48/end_event_error.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			state : {showType: 'text',type : 'state',
				name : {text:'<<state>>'},
				text : {text:'状态'},
				img : {src : '/resource/extnd/myFlow/img/48/task_empty.png',width : 48, height:48},
				props : {
			...
			fork : {showType: 'image',type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : '/resource/extnd/myFlow/img/48/gateway_parallel.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
